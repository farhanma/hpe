...
#
# xtfma_ato_test.py - a wrapper script used in conjunction with xtfma_ato_test.ini
#                       to execute the standard Cray xtfma_ato diagnostic
#
# author: Pete Halseth 
#
# The purpose of xtfma_ato_test.py is to provide the means to include 
# the standard Cray xtfma_ato diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtfma_ato_test.py <options> 
#    To see the available options, type: ./xtfma_ato_test.py -h 
#
# 2. To use within a script, just include the "import xtfma_ato_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtfma_ato_test
# a tool to execute the Cray xtfma_ato diagnostic 
import os,sys
...
class XtFmaAtoTest(BaseTestComponent):
    ...
    def get_test_script_parameters(self,number_of_test_copies=1,node_list_string=None,num_PEs=None,job_label=None):
        ...
        return parameter_template.replace("RANK",sysconfig.get_rank(len(node_list)))  
