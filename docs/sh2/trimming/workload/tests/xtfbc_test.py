...
#
# xtfbc_test.py - a wrapper script used in conjunction with xtfbc_test.ini
#                       to execute the standard Cray xtfbc diagnostic
#
# author: Pete Halseth 
#
# The purpose of xtfbc_test.py is to provide the means to include 
# the standard Cray xtfbc diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtfbc_test.py <options> 
#    To see the available options, type: ./xtfbc_test.py -h 
#
# 2. To use within a script, just include the "import xtfbc_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtfbc_test
...
class XtFbcTest(BaseTestComponent):
