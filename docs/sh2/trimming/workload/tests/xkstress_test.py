...
#
# xkstress_test.py - a wrapper script used in conjunction with xkstress_test.ini
#                       to execute the standard Cray xkstress diagnostic
#
# author: Pete Halseth
#
# The purpose of xkstress_test.py is to provide the means to include 
# the standard Cray xkstress diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xkstress_test.py <options> 
#    To see the available options, type: ./xkstress_test.py -h 
#
# 2. To use within a script, just include the "import xkstress_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xkstress_test
# a tool to execute the Cray xkstress diagnostic 
import os,sys
...
class XKStressTest(BaseTestComponent):
