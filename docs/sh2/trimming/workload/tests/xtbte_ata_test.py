...
#
# xtbte_ata_test.py - a wrapper script used in conjunction with xtbte_ata_test.ini
#                       to execute the standard Cray xtbte_ata diagnostic
#
# author: Pete Halseth 
#
# The purpose of xtbte_ata_test.py is to provide the means to include 
# the standard Cray xtbte_ata diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtbte_ata_test.py <options> 
#    To see the available options, type: ./xtbte_ata_test.py -h 
#
# 2. To use within a script, just include the "import xtbte_ata_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtbte_ata_test
...
class XtBteAtaTest(BaseTestComponent):
