...
#
# xta2a_batch_test.py - a wrapper script used in conjunction with xta2a_batch_test.ini
#                       to execute the standard Cray xta2a diagnostic
#
# author: Pete Halseth 
#
# The purpose of xta2a_batch_test.py is to provide the means to include 
# the standard Cray xta2a diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xta2a_batch_test.py <options> 
#    To see the available options, type: ./xta2a_batch_test.py -h 
#
# 2. To use within a script, just include the "import xta2a_batch_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xta2a_batch_test
...
class Xta2aBatchTest(BaseTestComponent):
