...
#
# xtmemory_test.py - a wrapper script used in conjunction with xtmemory_test.ini
#                       to execute the standard Cray xt memory diagnostics
#
# author: Pete Halseth
#
# The purpose of xtmemory_test.py is to provide the means to include 
# the standard Cray xt memory diagnostics as component tests in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtmemory_test.py <options> 
#    To see the available options, type: ./xtmemory_test.py -h 
#
# 2. To use within a script, just include the "import xtmemory_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtmemory_test
# a tool to execute the Cray xt memory diagnostics 
import os,sys
...
class XtMemoryTest(BaseTestComponent):
