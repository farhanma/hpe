...
#
# xthpl_multinode_test.py - a wrapper script used in conjunction with xthpl_multinode_test.ini
#                       to execute the standard IMB benchmarking tool 
#
# author: Pete Halseth
#
# The purpose of xthpl_multinode_test.py is to provide the means to include 
# the standard xhpl benchmarking tool as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xthpl_multinode_test.py <options> 
#    To see the available options, type: ./xthpl_multinode_test.py -h 
#
# 2. To use within a script, just include the "import xthpl_multinode_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xthpl_multinode_test
# a tool to execute the standard xhpl benchmark 
import os,sys
from xthpl_test import XTHplTest

class XTHplMultiNodeTest(XTHplTest):
