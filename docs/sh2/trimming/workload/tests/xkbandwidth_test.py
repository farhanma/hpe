...
#
# xkbandwidth_test.py - a wrapper script used in conjunction with xkbandwidth_test.ini
#                       to execute the standard Cray xkbandwidth diagnostic
#
# author: Pete Halseth
#
# The purpose of xkbandwidth_test.py is to provide the means to include 
# the standard Cray xkbandwidth diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xkbandwidth_test.py <options> 
#    To see the available options, type: ./xkbandwidth_test.py -h 
#
# 2. To use within a script, just include the "import xkbandwidth_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xkbandwidth_test
# a tool to execute the Cray xkbandwidth diagnostic 
import os,sys
...
class XKBandwidthTest(BaseTestComponent):
