...
#
# xtfma_ata_test.py - a wrapper script used in conjunction with xtfma_ata_test.ini
#                       to execute the standard Cray xtfma_ata diagnostic
#
# author: Pete Halseth 
#
# The purpose of xtfma_ata_test.py is to provide the means to include 
# the standard Cray xtfma_ata diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtfma_ata_test.py <options> 
#    To see the available options, type: ./xtfma_ata_test.py -h 
#
# 2. To use within a script, just include the "import xtfma_ata_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtfma_ata_test
# a tool to execute the Cray xtfma_ata diagnostic 
import os,sys
...
class XtFmaAtaTest(BaseTestComponent):
