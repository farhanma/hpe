...
#
# xtbte_perf_test.py - a wrapper script used in conjunction with xtbte_perf_test.ini
#                       to execute the standard Cray xtbte_perf diagnostic
#
# author: Pete Halseth 
#
# The purpose of xtbte_perf_test.py is to provide the means to include 
# the standard Cray xtbte_perf diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtbte_perf_test.py <options> 
#    To see the available options, type: ./xtbte_perf_test.py -h 
#
# 2. To use within a script, just include the "import xtbte_perf_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtbte_perf_test
...
class XtBtePerfTest(BaseTestComponent):
