...
#
# xkcheck_test.py - a wrapper script used in conjunction with xkcheck_test.ini
#                       to execute the standard Cray xkcheck diagnostic
#
# author: Pete Halseth
#
# The purpose of xkcheck_test.py is to provide the means to include 
# the standard Cray xkcheck diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xcheck_test.py <options> 
#    To see the available options, type: ./xkcheck_test.py -h 
#
# 2. To use within a script, just include the "import xkcheck_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xkcheck_test
# a tool to execute the Cray xkcheck diagnostic 
import os,sys
...
class XKCheckTest(BaseTestComponent):
            ...
            for name in supported_accelerator_names:
                if name in accelerator_configuration:
                    ...
                    if node_list:
                        ...
                        #no loop here because just one job is created!!!     
