...
#
# xtfma_ato_batch_test.py - a wrapper script used in conjunction with xtfma_ato_batch_test.ini
#                       to execute the standard Cray xtfma_ato diagnostic
#
# author: Pete Halseth 
#
# The purpose of xtfma_ato_batch_test.py is to provide the means to include 
# the standard Cray xtfma_ato diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtfma_ato_batch_test.py <options> 
#    To see the available options, type: ./xtfma_ato_batch_test.py -h 
#
# 2. To use within a script, just include the "import xtfma_ato_batch_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtfma_ato_batch_test
...
class XtFmaAtoBatchTest(BaseTestComponent):
