...
#
# xtcpuperf_test.py - a wrapper script used in conjunction with xtcpuperf_test.ini
#                       to execute the standard Cray xtcpuperf diagnostic
#
# author: Pete Halseth
#
# The purpose of xtcpuperf_test.py is to provide the means to include 
# the standard Cray xtcpuperf diagnostic as a component test in a list
# of tests grouped together in xtsystest.ini
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtcpuperf_test.py <options> 
#    To see the available options, type: ./xtcpuperf_test.py -h 
#
# 2. To use within a script, just include the "import xtcpuperf_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtcpuperf_test
# a tool to execute the Cray xtcpuperf diagnostic 
import os,sys
...
class XtCpuPerfTest(BaseTestComponent):
