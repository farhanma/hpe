...
#
# xtbte_ato_batch_test.py - a wrapper script used in conjunction with xtbte_ato_batch_test.ini
#                       to execute the standard Cray xtbte_ato diagnostic
#
# author: Pete Halseth 
#
# The purpose of xtbte_ato_batch_test.py is to provide the means to include 
# the standard Cray xtbte_ato diagnostic as a component test in a list
# of tests 
#
# Usage:
# -------
# 1. To run as a standalone test: ./xtbte_ato_batch_test.py <options> 
#    To see the available options, type: ./xtbte_ato_batch_test.py -h 
#
# 2. To use within a script, just include the "import xtbte_ato_batch_test" statement at 
# the top of the script
# 
################################################################################
##@package tests.xtbte_ato_batch_test
# a tool to execute the Cray xtbte_ato diagnostic 
import os,sys
...
class XtBteAtoBatchTest(BaseTestComponent):
